...
//         {/* Image Section */}
//         <div className="relative aspect-square rounded-2xl overflow-hidden border-2 border-indigo-800/50 bg-indigo-900/30 mb-8">
//           <img
//             src={machine.image}
//             alt={machine.model}
...
//             <h2 className="text-xl font-semibold text-indigo-100 mb-6">Technical Specifications</h2>
